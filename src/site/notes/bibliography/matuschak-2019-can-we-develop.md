...
visibility: public
year: 2019
zotero_key: matuschak-2019-howcanwe
---

[[-bibliography]]

Matuschak, Andy; Nielsen, Michael; Matuschak, Andy; Nielsen, Michael. _How can we develop transformative tools for thought?_. 2019. https://numinous.productions/ttft

---
'tools for thought' is an interesting terminology that may be directly useful for me to adopt in this research. They cite [Kenneth Iverson for originating the term](https://numinous.productions/ttft/assets/Iverson1979.pdf) but extend their definition to sometimes refer to it as a medium of thought. ~~Interestingly in my fist iteration writing [[live-coding-a-phd]] I talked about computation as a intermidiary material, so there may be some crossover in thinking here~~

they talk about a protoype tool for thought called the mnemonic medium a user interface to help people remember concepts and new ideas more easily
...
<mark style="background: #FFB8EBA6;">There’s a general principle here: _good tools for thought arise mostly as a byproduct of doing original work on serious problems_.</mark>