...
The framing of "After Intelligence" has always been centred around looking beyond the here and now. I know from my position as a lecturer the kind of struggles that take up the everyday, often around the correct mode of assessment, plagiarism, and other immediate concerns. But I wanted to look beyond this. At the moment, conversations about AI in education have a tendency to default to pro or anti stances. I wanted to look at a more nuanced position. Assuming the technology is here to stay, what might modes of learning look like that utilise and integrate these technologies, and how might we do so in ways that acknowledge the problems and ethical issues that are undoubtedly core to AI infrastructure?

When writing my initial proposal, it was still in the early days of ChatGPT's infiltration into the classroom. At that time I was clear on the framing of "looking beyond the present" and that I would adopt some kind of speculative approach, but I wasn't sure of what form exactly that would take. I also knew that in my role as a teacher I wanted to do something inclusive and informed by my students rather than from a top-down approach. However, it has become my experience as a student that has become a testbed for my primary investigations. Adopting an approach informed by autoethnography and by autobiographical design principles, my research process has become a prime site for many of my investigations into AI tools.

Primarily, it was through initial (and at the time I thought unconnected) work on the best system for note-taking throughout the research, and my discovery of Zettelkasten, that I began to realise directly that the knowledge I am generating day to day and the thinking being captured is the perfect place to speculate on AI implementation. From my position as a student I can test these early questions through my own process, with the plan to then extend that outward to the postgraduate student community through workshops and focus groups planned from year 3 onward.

Each substantive chapter of the thesis follows a two-movement structure. The first movement makes the conceptual argument, with pedagogy and learning as the orienting context. The second movement, through autoethnographic reflection on my own practice, deepens the pedagogical and learning questions beyond what the literature alone can reach. This structure is not signposted with subheadings within the chapters. Instead, the movements flow into each other as continuous prose, connected by explicit transitions. The reason for this structural choice is that pedagogy and autoethnography are not separate topics running alongside the argument; they are the argument's connective tissue.

This document lays out a contextual overview that shapes the work and talks through my growing practice, which is directly engaged in answering my research questions. I will also demonstrate my methodological approach in more detail through a draft section of chapter 2 (a "playful" methodology), and my documentation of the primary artefacts of the research through a draft section of chapter 4 (process, digital gardens, tools for thought, and knowledge infrastructure). Lastly I will provide the chapter outlines and my plan to completion, indicating the vision of the research moving forward.
...
this is the playful methodology in a nutshell
practice based research 
speculative design (thought experiments / possibility spaces)
play (bogost) and imagination (benjamin)
-> the above represented in the approach, live coding

"those who monopolize resources monopolize imagination" (benjamin)

This research draws together a number of methods and approaches that extend upon traditions of practice based research, in it's offer of capturing types of knowledge beyond the purely empirical. This is critical in the sphere of examining how LLMs are changing the nature of learning and knowledge production. Additionally in a contradiction to the inherent optimisation and productivity and polished outputs of LLMs, this research aims to confront this challenge by seeing what playful and improvisatory qualities bring into the frame in the process of conducting this research. 

At its foundation it builds on practice-based research (Frayling 1993, Candy 2006, Gaver 2012). These references matter for two reasons. First, they articulate how knowledge is made through making rather than only through writing, and they distinguish this from more traditional forms of research. Second, this research is itself concerned with how knowledge gets made, and specifically with the tension between the tacit, unfinished, embodied knowing that practice-based work centres, and the classificatory, algorithmic, output-oriented tendencies of generative AI systems. Practice-based research and generative AI operate on quite different assumptions about what knowledge is and how it becomes available. That tension is the ground the research works on.

Autoethnography as a research method has been articulated most fully in papers by Ellis (2004) and Ellis, Adams, and Bochner (2011), whose work establishes the tradition of using the researcher's own experience as data to study cultural phenomena. This research sits within that tradition but more specifically draws  on autoethnographic and autobiographical approaches within design research (Neustaedter and Sengers 2012, DiSalvo et al. 2019), where the researcher's engagement with their own artefacts is the specific site of inquiry.
